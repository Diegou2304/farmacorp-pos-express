...
namespace FarmacorpPOS.Infrastructure.Migrations
{
    ...
    [Migration("20231108181920_InitialMigration")]
            ...
            modelBuilder.Entity("FarmacorpPOS.Domain.ERP.ErpProduct", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ErpProductId = 1,
                            Cost = 6.0,
                            RegistrationDate = new DateTime(2023, 11, 8, 14, 19, 20, 659, DateTimeKind.Local).AddTicks(6663),
                            Stock = 100,
                            UniqueCode = new Guid("74dbb25f-2b36-4ade-9162-ca18ec3fd8d2")
                        });
                });
            ...
            modelBuilder.Entity("FarmacorpPOS.Domain.Express.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 1,
                            ExpirationDate = new DateTime(2023, 11, 8, 14, 19, 20, 659, DateTimeKind.Local).AddTicks(6642),
